...
object I18n {
    ...
    private val strings: Map<Lang, Map<String, String>> = mapOf(
        Lang.RU to mapOf(
            ...
            "routing_active" to "активна",
            "routing_checking" to "проверка",
            "routing_unreachable" to "нет связи",
            "language" to "Язык",
            "palette" to "Палитра",
            "background" to "Фон",
        ...
        Lang.EN to mapOf(
            ...
            "routing_active" to "active",
            "routing_checking" to "checking",
            "routing_unreachable" to "unreachable",
